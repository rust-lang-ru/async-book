...
In the previous section on [The `Future` Trait](./02_future.md), we discussed this example of
...
through the cross-platform Rust crate [`mio`](https://github.com/tokio-rs/mio)). These primitives all allow
